  ...
  return (
    <div className="container mx-auto flex items-center justify-between text-sm py-4 mb-5 border-b border-b-[#ADADAD]">
      <img
        ...
        alt=""
      />
      <ul className="md:flex items-start gap-5 font-medium text-[18px] hidden">
        <NavLink to="/">
          <li className="py-1">Home</li>
          <hr className="border-none outline-none h-0.5 bg-[#193378] w-3/5 m-auto hidden" />
        </NavLink>
        <NavLink to="/about">
      ...
      <div className="flex items-center gap-4 ">
        {token && userData ? (
          ...
          <button
            ...
            className="bg-[#193378] text-white text-[18px] px-8 py-3 rounded-full font-light hidden md:block"
          >
            Create account
          </button>
        )}
